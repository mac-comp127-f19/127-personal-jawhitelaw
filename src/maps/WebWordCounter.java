...
public class WebWordCounter {
    ...
    private static String TEST_URL = "http://textfiles.com/food/candy.txt";
    ...
    public static void main(String [] args) {
        ...
        List<String> words = new ArrayList<String>(urlToWords(TEST_URL));
        ...
        wordCount.entrySet().stream().filter(a -> a.getValue()>=450).sorted(Comparator.comparing(a -> a.getValue()*-1)).forEach(System.out::println);
    }
    ...
    public static Set<String> STOP_WORDS = Set.of(
            ...
            "yet", "you", "your", "yours", "yourself", "yourselves", "mmmmm", "c"
    );
}
