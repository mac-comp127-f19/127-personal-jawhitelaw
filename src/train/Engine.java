...
public class Engine extends TrainCar {
    ...
    public Engine (Color color){
        super(color);
        this.color = color;
        drawCowcatcher(0,this.getCarHeight());
        drawEngineCab(0,this.getCarHeight());
        drawSmokestack(0,this.getCarHeight());
    }

    /* Draws the smokestack */
    public void drawSmokestack(double x, double y) {
        // You fill this in //
    ...
    public void drawEngineCab(double x, double y) {
    ...
    public void drawCowcatcher(double x, double y) {
        // You fill this in //
        double x1 = x;
